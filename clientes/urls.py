...
urlpatterns = [
    ...
    path('expediente/actualizar/', views.actualizar_expediente, name='actualizar_expediente'),
    ...
    path('expediente/eliminar-documento/', views.eliminar_documento, name='eliminar_documento'),
